...
public class Data {
    ...
    static {
        ...
        data.put("client4", new NodeData(new String[0],"10.0.2.21", new String[]{"10.0.2.20"}));
        data.put("node1", new NodeData(new String[0],"10.0.6.21", new String[]{"10.0.6.20"}));
        data.put("node2", new NodeData(new String[0],"10.0.3.20", new String[]{"10.0.3.21"}));
        data.put("node3", new NodeData(new String[0],"10.0.7.21", new String[]{"10.0.7.20"}));
    }
}
